...
: Possible RII outcomes for binary (0/1) data {#tbl-posible.RII}
...
[^1]: This approach produces many RII values per individual. The repeated-measures structure allows the use of mixed models to account for nested observations. However, this is not addressed in this report.
...
emm <- emmeans(m1, specs = ~ type_RII | Interacting_species, type = "response")
